...
design + the MND scoping-review demonstration (~2,200 papers audited, ~13,000
ratings, blind-recheck calibration drift of 67.5% exact / 96.7% within-one-grade).
...
Submodules:
    ...
    exclusions   — multi-heuristic exclusion detection (dupes, non-English,
                   boilerplate, title-vs-text mismatch, MND-keyword absence)

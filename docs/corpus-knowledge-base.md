...
7. Document a Next.js/Vercel consumer pattern without making it the only supported UI.
8. Keep the MND project as regression dogfood for scale, messy metadata, rater disagreement, and private source access.
